...
class TestSpeechDetector(unittest.TestCase):
    ...
    def test_run_with_profile_manager(self):
        ...
        self.detector._profile_manager.get_speaker_name.return_value = {
            "name": "Speaker 1",
            "id": 0,
            "score": 1.0,
        }
    ...
    def test_handle_speech_end(self, mock_uuid4):
        ...
        self.detector.speaker_scores = [
            [0, 1, 2, 0],
            [3, 0, 0, 0],
            [0, 4, 0, 0],
            [0, 0, 5, 0],
            [6, 7, 8, 0],
        ]  # The expected sum is [9, 12, 15, 0]
        ...
        mock_uuid4.assert_called_once()
        self.detector._profile_manager.get_speaker_name.assert_called_once_with(
            [9, 12, 15, 0]
        )
    ...
    def test_handle_collected_chunks_no_overflow(self):
        ...
        self.detector._speaker_profiles = [
            {"profile_data": b"data", "name": "Speaker1"}
        ]
        self.detector._handle_collected_chunks_overflow(50)
